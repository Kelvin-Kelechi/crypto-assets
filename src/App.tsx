...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 font-sans selection:bg-green-100 dark:selection:bg-green-900 selection:text-green-900 dark:selection:text-green-100">
      {/* Abstract Background Pattern */}
      <div className="fixed inset-0 z-0 pointer-events-none opacity-60 dark:opacity-20">
