...
export const CryptoItem = ({ asset, index }: CryptoItemProps) => {
  return (
    <motion.div
      ...
      className="relative overflow-hidden bg-white/70 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 group flex flex-col items-center justify-center p-8 text-center"
    >
